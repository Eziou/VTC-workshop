...
class GRUNetWithMLP(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, dropout_rate, num_classes):
        ...
        self.mlp = nn.Sequential(
            nn.Linear(hidden_size, 64),  # 隐藏层大小
            nn.ReLU(),
...
model = GRUNetWithMLP(X_train_tensor.size(1), hidden_size, num_layers, dropout_rate, num_classes)
...
# 保存最终模型
model_path = '/Users/han/Charging station/model/213——GRU_with_MLP.pth'
