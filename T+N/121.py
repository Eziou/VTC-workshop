...
class LSTMNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out, _ = self.lstm(x, (h0, c0))  # LSTM 的输出
...
def random_search(X_train_tensor, y_train_tensor, param_distributions, num_samples):
    ...
    for params in param_sampler:
        ...
        # 初始化模型
        model = LSTMNet(X_train_tensor.size(1), hidden_size, num_layers, 2, dropout_rate)
        model.to(device)
...
# 保存最终模型
model_path = '/Users/han/Charging station/model/121——LSTMmodel.pth'
